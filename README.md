...
```text
to-java.xsl              77018  41.74%
classes.xsl              58238  31.56%
set-locators.xsl         12687  6.88%
set-original-names.xsl   8853   4.80%
attrs.xsl                6966   3.78%
data.xsl                 6351   3.44%
tests.xsl                4940   2.68%
anonymous-to-nested.xsl  4747   2.57%
package.xsl              4706   2.55%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-08-06 at 16:25,
on Linux with 4 CPUs.
The total is 184506 milliseconds.
...
[benchmark-gha]: https://github.com/uchitsa/eo/actions/runs/16782483478
