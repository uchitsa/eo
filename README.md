...
```text
to-java.xsl                          63822  33.70%
add-refs.xsl                         21312  11.25%
set-locators.xsl                     10864  5.74%
tests.xsl                            9968   5.26%
rename-tests-inners.xsl              8295   4.38%
add-probes.xsl                       5811   3.07%
classes.xsl                          5746   3.03%
resolve-aliases.xsl                  5436   2.87%
explicit-data.xsl                    5109   2.70%
add-default-package.xsl              4994   2.64%
vars-float-up.xsl                    4908   2.59%
package.xsl                          4877   2.58%
cti-adds-errors.xsl                  4775   2.52%
expand-qqs.xsl                       4060   2.14%
expand-aliases.xsl                   3854   2.03%
clean-up.xsl                         3731   1.97%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2024-12-27 at 23:40,
on Linux with 4 CPUs.
The total is 189391 milliseconds.
...
[benchmark-gha]: https://github.com/uchitsa/eo/actions/runs/12521776703
