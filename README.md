...
```text
to-java.xsl              72725  41.29%
classes.xsl              52120  29.59%
set-locators.xsl         14838  8.42%
set-original-names.xsl   9874   5.61%
attrs.xsl                6508   3.69%
data.xsl                 6065   3.44%
anonymous-to-nested.xsl  4810   2.73%
tests.xsl                4792   2.72%
package.xsl              4411   2.50%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-07-11 at 23:23,
on Linux with 4 CPUs.
The total is 176143 milliseconds.
...
[benchmark-gha]: https://github.com/uchitsa/eo/actions/runs/16231434230
